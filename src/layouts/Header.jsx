...
const Header = () => {
  return (
    <header className='bg-navy flex justify-between items-center px-6 py-2 sm:mt-10 sm:mx-10 sm:rounded-[10px] sm:px-3 sm:justify-normal'>
      <div className='hidden sm:flex sm:items-center'>
        <img
          src={suggestionsIcon}
          alt='suggestions icon'
        />
        <h2 className='text-white font-bold text-[13px] ml-2'>Suggestions</h2>
      </div>
      <FilterDropdown />
